...
$sentenciamsg = $conection->prepare("SELECT * FROM OHTLI_Msg");
...
switch ($accion) {
    ...
    case "Supprimer":
        $sentenciamsg = $conection->prepare("DELETE FROM OHTLI_Msg WHERE ID=:ID");
                ...
                <div class="contt">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($list as $book) { ?>
                                <tr>
                                    <td><?php echo $book['DateMsg'] ?></td>
                                    <td>
                                        <a href="" data-bs-toggle="modal" data-bs-target="#modalId">Voir Message</a>
                                    </td>
                                    <td><?php echo $book['NetP'] ?></td>
